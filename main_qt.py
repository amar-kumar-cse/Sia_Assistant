"""
SIA - Professional Desktop Virtual Assistant
Advanced Transparent UI with Live Animation Sync
...
class VoiceThread(QThread):
    """Background thread for voice processing to keep UI responsive."""
    finished = pyqtSignal()
...
class AnimatedCharacterWidget(QLabel):
    ...
    def __init__(self, parent=None):
        ...
        # Sync timer - checks voice state every 100ms
    ...
    def load_animations(self):
        ...
        if os.path.exists(idle_gif_path):
            ...
            idle_png = os.path.join(self.assets_path, "sia_idle_1.png")
            if os.path.exists(idle_png):
                self.idle_movie = QPixmap(idle_png).scaled(400, 400, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        ...
        if os.path.exists(talk_gif_path):
            ...
            # Fallback to static PNG
            talk_png = os.path.join(self.assets_path, "sia_talk_1.png")
            if os.path.exists(talk_png):
                self.talking_movie = QPixmap(talk_png).scaled(400, 400, Qt.KeepAspectRatio, Qt.SmoothTransformation)
...
class TransparentOverlay(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowFlags(
            ...
            Qt.WindowTransparentForInput  # Click-through for background
        )
        
        # Remove click-through for the widget itself
        self.setWindowFlags(
...
def main():
    ...
    print("\n" + "="*60)
    print("🎀 SIA - Professional Desktop Virtual Assistant")
    print("="*60)
    ...
    print("✅ Sia is live on your desktop!")
